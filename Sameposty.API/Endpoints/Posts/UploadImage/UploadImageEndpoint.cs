...
public class UploadImageEndpoint(IImageSaver imageSaver, IHttpContextAccessor httpContextAccessor, ICommandExecutor commandExecutor) : Endpoint<UploadImageRequest>
{
