...
public class SamepostyDbContextFactory : IDesignTimeDbContextFactory<SamepostyDbContext>
{
    public SamepostyDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseSqlServer("Server=SURFACEPRO7-MAR;Initial Catalog=Sameposty;Integrated Security=True;Trust Server Certificate=True");
...
//Source=SURFACEPRO7-MAR;Initial Catalog=Sameposty;Integrated Security=True;Trust Server Certificate=True