...
namespace Sameposty.DataAccess.Migrations
{
    ...
    [Migration("20241219202247_USerHasLimtPots")]
    partial class USerHasLimtPots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sameposty.DataAccess.Entities.Invoice", b =>
                {
                    ...
                    b.Property<long>("FakturowniaInvoiceId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sameposty.DataAccess.Entities.User", b =>
                {
                    ...
                    b.Property<int>("ImageTokensLeft")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PostsToGenerateLeft")
                        .HasColumnType("int");
