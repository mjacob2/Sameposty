...
namespace Sameposty.DataAccess.Migrations
{
    ...
    [Migration("20240413213223_SubscriptionHasOnlyCardId")]
    partial class SubscriptionHasOnlyCardId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sameposty.DataAccess.Entities.Subscription", b =>
                {
                    ...
                    b.Property<string>("StripeCusomerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StripePaymentCardId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
